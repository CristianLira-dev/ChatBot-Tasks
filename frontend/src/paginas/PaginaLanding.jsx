...
function LogoPlaceholder({ compact = false }) {
  return <span className={compact ? 'landing-logo compact' : 'landing-logo'}><span className="landing-logo-mark"><Icon name="spark" size={compact ? 14 : 16} /></span><span>MARCA</span></span>;
}
...
function PhoneMockup({ step = 5, compact = false }) {
  ...
  return <div className={`phone-wrap ${compact ? 'compact' : ''}`}>
    ...
    <div className="phone-shell">
      ...
      <div className="phone-topbar"><div className="phone-profile"><span className="phone-avatar"><Icon name="spark" size={12} /></span><span><strong>Assistente</strong><small>online agora</small></span></div><span className="phone-more">•••</span></div>
